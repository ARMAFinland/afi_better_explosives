...
switch(_ammo) do {
  ...
  case "Tripflare_Ammo_Ground_Red": { ["Tripflare_Flare_Red", 0] };
  case "Tripflare_Ammo_Ground_Yellow": { ["Tripflare_Flare_Yellow", 0] };
  case "Tripflare_Ammo_Ground_Green": { ["Tripflare_Flare_Green", 0] };
  case "Tripflare_Ammo_Ground_White": { ["Tripflare_Flare_White", 0] };

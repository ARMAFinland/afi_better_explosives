systemchat "DEBUG: AT START OF MINE PLACED SCRIPT"; // This will dump text to the screen
diag_log text "DEBUG: AT START OF MINE PLACED SCRIPT"; // This will dump text to the rpt file
...
systemchat "DEBUG: AT END O MINE PLACED SCRIPT"; // This will dump text to the screen
diag_log text "DEBUG: AT END OF MINE PLACED SCRIPT"; // This will dump text to the rpt file